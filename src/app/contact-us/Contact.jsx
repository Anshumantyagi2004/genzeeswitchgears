    ...
    const cardData = [
        ...
        },
        {
            ...
            content: [
                ...
                "First Floor, 345a-345b, Sahibabad, Gali No 3 Ghaziabad - 201005, Uttar Pradesh, India"
            ],
        },
    ];
                ...
                <div className="grid md:grid-cols-3 md:gap-8 gap-5">
                    {cardData.map((card, index) => (
                        <motion.div
                            ...
                            className="group bg-white flex flex-col items-center text-center rounded-2xl p-6 shadow-md border border-gray-200 hover:shadow-xl transition duration-300"
                        >
                            {/* Icon + Title */}
                            <div className="flex flex-col items-center gap-4 mb-4">
                                <div className="w-14 h-14 flex items-center justify-center rounded-full bg-gray-200 text-gray-600 text-2xl group-hover:bg-gray-900 group-hover:text-white transition duration-300">
                                    {card.icon}
                                </div>
